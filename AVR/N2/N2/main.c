...
uint8_t N2_payload_TX[PAYLOAD_LEN] = {0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28};
...
void AVR_Init(void)
{
	//Set the Clock Prescaler division factor to 2(F_CPU = 8MHz)
