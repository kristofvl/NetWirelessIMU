...
#include <stdlib.h>
#include <avr/power.h>
#define F_CPU 8000000UL	//16 MHz frequency
#define BAUD  9600
...
//	int16_t Word_Data = 25000;

//	char Euler_Angles[] = {100, 200, 250};
...
//	itoa(Word_Data, String_Data, 10);  //convert integer to string, radix=10
/*
	i2c_start_wait(BNO055_ADDRESS+I2C_WRITE);	//Set device address and read mode
	i2c_write(BNO055_OPR_MODE_ADDR);
	i2c_write(OPERATION_MODE_NDOF);		//Set operation mode to IMU
