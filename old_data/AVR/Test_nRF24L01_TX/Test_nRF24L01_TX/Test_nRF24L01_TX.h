...
#define NRF24L01_CHANNEL		0x69	//Channel 105 i.e. @2.505 GHz

//Data-pipe
#define NRF24L01_ERX_PN			0x01	//Enable data-pipe 0
...
//nRF config
//Boot the nrf and mask the maximum retransmission interrupt(disable)
//Enable CRC and set the length to 2-bytes
#define NRF24L01_DEFAULT_CONFIG		0x1C
#define NRF24L01_TX_CONFIG		0x1E
#define NRF24L01_RX_CONFIG		0x1F
